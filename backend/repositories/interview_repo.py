...
def restore_session(session_id: str) -> dict | None:
    ...
    chat_sessions[session_id] = {
        ...
        "question_attempts": record.get("question_attempts", {}),
        "answer_evaluations": record.get("answer_evaluations", []),
        "resume_context": record.get("resume_context", ""),
        "jd_context": record.get("jd_context", ""),
